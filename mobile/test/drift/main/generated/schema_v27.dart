...
class TrashSyncEntity extends Table
  ...
  late final GeneratedColumn<int> triggerSource = GeneratedColumn<int>(
    'trigger_source',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  bool get isStrict => true;
  @override
  List<String> get customConstraints => const ['PRIMARY KEY(local_asset_id)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class TrashSyncEntityData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['trigger_source'] = Variable<int>(triggerSource);
  ...
  factory TrashSyncEntityData.fromJson(
    ...
    return TrashSyncEntityData(
      ...
      triggerSource: serializer.fromJson<int>(json['triggerSource']),
      albumId: serializer.fromJson<String?>(json['albumId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'triggerSource': serializer.toJson<int>(triggerSource),
      'albumId': serializer.toJson<String?>(albumId),
  ...
  TrashSyncEntityData copyWith({
    ...
    Value<String?> remoteDeletedAt = const Value.absent(),
    String? decidedAt,
    int? isFavorite,
    int? orientation,
    int? playbackStyle,
...
class TrashSyncEntityCompanion extends UpdateCompanion<TrashSyncEntityData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (triggerSource.present) {
      map['trigger_source'] = Variable<int>(triggerSource.value);
    }
    if (albumId.present) {
      map['album_id'] = Variable<String>(albumId.value);
    }
...
class DatabaseAtV27 extends GeneratedDatabase {
  ...
  late final Index idxTrashSyncDecision = Index(
